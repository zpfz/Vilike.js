...
/* harmony import */ var cross_fetch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
...
Vilike.exec = function (pkey, skey, mode) {
  return new Promise(function (resolve, reject) {
    ...
    switch (mode) {
      case 0:
        fetchJson("".concat(BASE_API_PATH, "/hit/").concat(pkey, "/").concat(skey)).then(function (res) {
          resolve(res);
        })["catch"](function (err) {
          reject(err);
        });
      ...
      case 1:
        ...
        if (keyVal === null) {
          ...
          fetchJson("".concat(BASE_API_PATH, "/get/").concat(pkey, "/").concat(skey)).then(function (res) {
            Object.assign(newRes, res, {
              isHit: true
            });
            resolve(newRes);
...
Vilike.create = function (pkey, skey, value, ctrl, upperbound) {
  return new Promise(function (resolve, reject) {
    ...
    fetchJson("".concat(BASE_API_PATH, "/create?namespace=").concat(pkey, "&key=").concat(skey, "&value=").concat(value, "&enable_reset=").concat(ctrl, "&update_upperbound=").concat(upperbound, "&update_lowerbound=0")).then(function (res) {
      resolve(res);
    })["catch"](function (err) {
      reject(err);
    });
...
Vilike.update = function (pkey, skey, value, type) {
  return new Promise(function (resolve, reject) {
    ...
    switch (type) {
      case 0:
        value = value === undefined || value === '' ? 0 : value;
        fetchJson("".concat(BASE_API_PATH, "/set/").concat(pkey, "/").concat(skey, "?value=").concat(value)).then(function (res) {
          resolve(res);
        })["catch"](function (err) {
          reject(err);
        });
      ...
      case 1:
        ...
        fetchJson("".concat(BASE_API_PATH, "/update/").concat(pkey, "/").concat(skey, "?amount=").concat(value)).then(function (res) {
          resolve(res);
        })["catch"](function (err) {
          reject(err);
        });
...
Vilike.info = function (pkey, skey) {
  return new Promise(function (resolve, reject) {
    ...
    fetchJson("".concat(BASE_API_PATH, "/info/").concat(pkey, "/").concat(skey)).then(function (res) {
      resolve(res);
    })["catch"](function (err) {
      reject(err);
    });
...
function fetchJson(url) {
  return new Promise(function (resolve) {
    cross_fetch__WEBPACK_IMPORTED_MODULE_0___default()(url).then(function (res) {
      return res.json();
    }).then(function (data) {
      resolve(data);
    })["catch"](function (err) {
...
/* harmony default export */ __webpack_exports__["default"] = (Vilike);
